...
const Footer = () => (
  <footer className=' px-[20px] sm:px-[60px] lg:px-[90px] xlb:px-[120px] py-[4rem] bg-white opacity-[0.8] w-full flex items-center flex-col justify-center'>
    ...
    <div className=" flex-wrap px-[20px] xxm:px-[40px]  md:flex-nowrap flex gap-[5px] xxm:gap-[10px] mdd:gap-[30px] lg:gap-[50px] items-start justify-start md:justify-center w-full">
      <div className=" w-full xsm:w-[60%] md:w-[45%] mdd:w-[40%] flex flex-col gap-[20px]">
        ...
        <p className="text-[#656B70] text-[14px] lg:text-[14px] font-[500]"> <span className="text-[14px] lg:text-[16px]" >OFFSHORE OFFICE 1</span> <br /> Augustine Heights, Queensland, 4300, Australia</p>
