    ...
    <div className=" flex-wrap px-[20px] xxm:px-[40px]  md:flex-nowrap flex gap-[5px] xxm:gap-[10px] mdd:gap-[30px] lg:gap-[50px] items-start justify-start md:justify-center w-full">
      <div className=" w-full xsm:w-[60%] md:w-[45%] mdd:w-[40%] flex flex-col gap-[20px]">
        <div className="flex items-center justify-start gap-[10px]">
         <Link target="_blank" className="text-[23px] hover:text-[#1d1d1e] duration-500 hover:scale-110 text-[#656B70]" href="https://www.linkedin.com/company/digitaljoyn/" > <FaLinkedinIn className="text-[#0077B5] hover:text-[#1d1d1e] duration-500 hover:scale-110 text-[23px]" /></Link>
      ...
      <div className="flex flex-col xxm:mt-0 w-full xxm:w-[30%] md:w-[30%] gap-4 items-start">
        <p className="text-[#656B70] text-[16px] font-Noto font-[500] mb-[20px]">COMPANY</p>
      ...
      <div className="flex flex-col md:mt-0 mt-[30px] w-full ssm:w-[60%] xxm:w-[60%] md:w-[30%] gap-4 items-start">
        <p className="text-[#656B70] text-[16px] font-Noto font-[500] mb-[20px]">SERVICES</p>
