    ...
    <>
      ...
      <section className='max-w-[1440px] w-full my-[20px] sm:my-[10px] h-full flex items-center justify-center flex-col px-[20px] sm:px-[60px] lg:px-[90px] xlb:px-[120px] py-[2rem] mx-auto'>
        ...
        <motion.div initial={htini}
          ...
          <h5 className='text-[#2e2e2e] text-[25px] leading-normal mdd:leading-[72px] ssm:text-[30px] mdd:text-[40px] xll:text-[50px] font-[600] w-full md:text-left md:w-[65%]  lg:w-[60%] xll:w-[65%] font-Montserrat'>We offer complete digital transformation services to our clients by planning, designing, developing and implementing solutions and products. </h5>
        </motion.div>
        ...
        <motion.div initial={htini}
          ...
          <h5 className='text-[#2E2E2E] leading-normal xlb:leading-[58px] font-Montserrat font-[500] flex-1   sm:text-start text-[40px] mt-[-10px] lg:mt-[-20px] xll:text-[48px]'>
            Product/Solution<span className='font-bold'> Design</span>
          </h5>
          ...
          <div className='flex flex-col items-center md:items-start w-full md:w-[65%]  lg:w-[60%] xll:w-[65%]'>
            ...
            Product requirements gathering <br />
            Digital transformation journey mapping <br />
            Brand identity and design <br />
            Web and Mobile Visual Design
            </p>
