...
const ProtfolioCardReverse = ({ logo, spanTitle, title, desc, image, id }) => {
    ...
    return (
        <motion.div initial={{ opacity: 0, x: 200 }}
            ...
            transition={tranitiom} className='flex flex-col mdd:flex-row-reverse my-[20px] rounded-[30px] h-auto  mdd:h-[420px] lg:h-[490px] xlg:h-[510px]  xll:h-[490px]  w-full relative items-center justify-center'>
