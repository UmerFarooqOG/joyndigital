...
const ProtfolioCard = ({ logo, spanTitle, title, desc, image, id, isMobile }) => {
  ...
  return (
    <motion.div initial={initialAnimation} whileInView={whileInViewAnimation} transition={transition} className='flex flex-col mdd:flex-row my-[20px] h-auto mdd:h-[420px] lg:h-[490px] xlg:h-[510px]  xll:h-[490px] w-full relative items-center justify-center'>
      <div className=' rounded-se-[20px] mdd:rounded-e-[0px] rounded-ss-[20px] mdd:rounded-s-[30px] h-full w-full  mdd:w-[45%] flex flex-col gap-[16px] px-[20px] xsm:px-[20px] xlg:px-[30px] xll:px-[55px] py-[20px] items-start justify-center ssm:py-[60px]  bg-white '>
        ...
        <h3 className='text-[15px] leading-normal mdd:leading-[38px]ssm:text-[18px] xsm:text-[22px] lg:text-[28px] font-normal font-Montserrat'><span className='text-[#2957A7] font-bold'>{spanTitle} </span>{title} <br /></h3>
