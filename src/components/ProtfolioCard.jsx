...
const ProtfolioCard = ({ logo, spanTitle, title, desc, image,id }) => {
    ...
    return (
        ...
        transition={tranitiom}  className='flex flex-col mdd:flex-row my-[20px] rounded-[30px] h-auto mdd:h-[550px] lg:h-[700px] xlb:h-[624px] w-full relative items-center justify-center'>
