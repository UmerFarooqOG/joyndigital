...
const ProtfolioCard = ({ logo, spanTitle, title, desc, image,id }) => {
    ...
    return (
        ...
        transition={tranitiom}  className='flex flex-col mdd:flex-row my-[20px] rounded-[30px] h-auto mdd:h-[420px] lg:h-[490px] xlg:h-[500px]  xll:h-[490px] w-full relative items-center justify-center'>


            <div className='rounded-[20px] mdd:rounded-e-[0px] rounded-s-[20px] mdd:rounded-s-[30px] h-full w-full my-[40px] mdd:w-[45%] flex flex-col gap-[20px] px-[20px] xsm:px-[20px] xlg:px-[30px] xll:px-[55px] py-[20px] items-start justify-center ssm:py-[60px]  bg-white '>
