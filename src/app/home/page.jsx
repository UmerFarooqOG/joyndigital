...
const page = () => {
  ...
  return (
    ...
    <motion.div initial={{opacity : 0 , y:-100, scale:0.7  }}
              ...
              transition={tranitiom} className='bg-[#333] w-full h-full rounded-[10px] xsm:rounded-[48px]'>
