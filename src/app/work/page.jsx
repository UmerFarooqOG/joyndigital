    ...
    <div className='overflow-hidden h-full'>
      ...
      {protIdData.map((item, index) => (
            index % 2 === 0 ? (
              ...
              <div className='rounded-[20px] rounded-e-[20px] mdd:rounded-e-[0px]  rounded-s-[30px]  h-full w-full my-[40px] mdd:w-[45%] flex flex-col gap-[16px] px-[20px] xsm:px-[20px] xlg:px-[30px] xll:px-[55px] py-[20px] items-start justify-center  ssm:py-[60px]  bg-white '>
                <Image src={item.logo} loading='lazy' width={100} height={100} className='w-[120px] lg:w-[228px] h-[70px]' alt='Logo' />
                <h3 className='text-[15px] leading-[38px] ssm:text-[18px] xsm:text-[22px] lg:text-[28px] font-normal font-Montserrat'><span className='text-[#EB2022] font-bold'>{item.spanTitle}</span>{item.title}</h3>
              ...
              <div style={blueGradient} className='overflow-hidden flex items-center justify-center h-full rounded-[20px] mdd:rounded-s-[0px] rounded-e-[20px] mdd:rounded-e-[30px] px-[20px] xsm:px-[30px] lg:px-[70px] py-[20px] xsm:py-[40px] lg:py-[80px] bg-l w-full mdd:w-[55%] lg:w-[60%] '>
              ...
              <div style={redGradient} className='overflow-hidden flex items-center justify-center h-full rounded-[20px] mdd:rounded-e-[0px] rounded-s-[20px] mdd:rounded-s-[30px] px-[20px] xsm:px-[30px] lg:px-[70px] py-[20px] xsm:py-[40px] lg:py-[80px] bg-l w-full mdd:w-[55%] lg:w-[60%] '>
