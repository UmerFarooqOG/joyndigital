    ...
    <>
      ...
      {loader ? <Loading /> :
        <div className='overflow-hidden w-full mx-auto'>
          ...
          <section className='max-w-[1440px] w-full my-[20px]  sm:my-[40px] h-auto md:h-full flex items-center justify-center px-[20px] sm:px-[60px] lg:px-[90px] xlb:px-[120px] py-[2rem] mx-auto'>
          ...
          <section className='max-w-[1440px] w-full my-[20px] sm:my-[80px] h-full flex items-center justify-center flex-col gap-[40px] px-[20px] sm:px-[60px] lg:px-[90px] xlb:px-[120px] py-[2rem] mx-auto'>
            ...
            <motion.div initial={{ opacity: 0, x: -300 }}
              ...
              <motion.div initial={{ opacity: 0, x: 300 }}
                whileInView={{ opacity: 1, x: 0 }}
                transition={{ duration: 1, type: 'tween' }} className='flex flex-wrap mt-[40px] py-[30px] items-center gap-[30px] mdd:gap-[40px] xll:gap-[60px] w-full text-center sm:text-left sm:w-[65%]  lg:w-[60%] xll:w-[65%]'>
