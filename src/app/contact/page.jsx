            ...
            <div className='max-w-[1500px] overflow-hidden w-full mx-auto'>
                ...
                <main className='w-full my-[20px] sm:my-[20px] h-full flex items-center justify-center flex-col gap-[60px] px-[5px] ssm:px-[20px] xsm:px-[40px] py-[2rem] mx-auto'>
                    ...
                    <motion.div initial={{ opacity: 0, x: -180 }}
                        ...
                        <h5 className='text-[#2e2e2e] text-[16px] ssm:text-[20px] mdd:text-[30px] xll:text-[40px] font-[600] w-full sm:text-left sm:w-[65%]  lg:w-[60%] xll:w-[65%] font-Montserrat'>We&apos;d love to learn more about your project. Just fill out the form below and youll hear from us.</h5>
                    </motion.div>
