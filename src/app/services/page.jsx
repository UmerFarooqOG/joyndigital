    ...
    <div className='max-w-[1500px] overflow-hidden w-full mx-auto'>
      ...
      <section className='w-full mt-[80px]  px-[20px] xsm:px-[40px] py-[2rem] mx-auto'>
        <motion.h2 initial={{ opacity: 0, x: -100 }}
          ...
          transition={{ duration: 1, type: 'tween' }} className=' text-[14px] ssm:text-[24px] xsm:text-[35px] md:text-[40px] mdd:text-[70px] w-full text-[#2E2E2E] font-Montserrat font-semibold'>The services <br /> we offer</motion.h2>
      </section>
      ...
      <section className='w-full my-[20px] sm:my-[80px] h-full flex items-center justify-center flex-col gap-[60px] px-[20px] xsm:px-[40px] py-[2rem] mx-auto'>
        ...
        <motion.div initial={{ opacity: 0, x: -180 }}
          ...
          <h5 className='text-[#2e2e2e] text-[16px] ssm:text-[20px] mdd:text-[30px] xll:text-[40px] font-[600] w-full sm:text-left sm:w-[65%]  lg:w-[60%] xll:w-[65%] font-Montserrat'>We create custom web & mobile digital products that inspire and engage your customers</h5>
        </motion.div>
        ...
        <motion.div initial={{ opacity: 0, x: 200 }}
          whileInView={{ opacity: 1, x: 0 }}
          transition={{ duration: 1, type: 'tween' }} className='w-full flex flex-col sm:flex-row  gap-[10px] mdd:gap-[30px] justify-center sm:items-start'>
          <h5 className='text-[#2E2E2E] font-Montserrat font-[500] flex-1 text-[20px] xsm:text-[30px] sm:text-start sm:text-[20px] mdd:text-[25px] lg:text-[35px] mt-[-10px] lg:mt-[-20px]  xll:text-[45px]'>
            Product <span className='font-bold'> <br />Design</span>
          </h5>

          <div className='flex flex-col sm:w-[65%]  lg:w-[60%] xll:w-[65%]'>
            <p className='text-[#7F7F7F] text-[10px] xsm:text-[14px] mdd:text-[16px] xll:text-[18px] font-normal w-full sm:text-left leading-7 font-Noto'>
      ...
      <motion.div initial={{ opacity: 0, y: 220 }}
        ...
        <div className='w-full flex-wrap gap-[20px] h-full flex justify-between items-center'>
          <div >
            <h2 className='font-Montserrat font-bold text-[25px] xsm:text-[30px] md:text-[40px] text-[#fff]'>Partner with us</h2>
            <p className='font-Noto text-[12px] xsm:text-[14px] md:text-[16px] text-[#F2EEEE]'>We’d love to learn more about your digital project and see <br /> how we can help you</p>
          </div>
          <div className=''>
